...
I must warn you that this is an incomplete writeup, I had been unable to finish all the challenges due to other important events in life.
...
player.takeHit function takes two arguments, we will overwrite it with another function, that takes the same two arguments but does nothing.
We set our own throw Delay to 0 to become a snowball machine-gun while setting everyone else's throw delay longer than their lifespans.
...
In this version of the game, our initial position is set next to a portal. Interacting with the portal
...
![The different capitalizations of NaN for each pick]()
...
Phishing Detection Agency Logo
